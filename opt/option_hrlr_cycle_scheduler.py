...
parser.add_argument('--interval1', type=int, default=5e3, help='1st step size (iteration)')
parser.add_argument('--interval2', type=int, default=1e4, help='2nd step size (iteration)')
parser.add_argument('--interval3', type=int, default=2e4, help='3rd step size (iteration)')
parser.add_argument('--interval4', type=int, default=3e4, help='4th step size (iteration)')
