...
class Testdataset(Dataset):
    def __init__(self, path_gt, path_lq, transform, patch_size = 64, scale=4, crop_mode = False):
...
class LQGTDataset(Dataset):
    def __init__(self, lrpath,gtpath, transform, patch_size = 64, shuffle_mode=False, scale=4):
