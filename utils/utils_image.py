...
if __name__ == '__main__':
    ...
    sf = 3    
#    # numpy imresize
#    print('org img:', img.shape, img.min(), img.max())
#    plt.figure()
#    plt.imshow(img)
#    
#    lr_img = imresize_np(img, scale=1/4).clip(0,1)
#    
#    print('lr img:', lr_img.shape, lr_img.min(), lr_img.max())
#    plt.figure()
#    plt.imshow(lr_img)
    ...
    lr_img = imresize(img, scale=1/sf).clamp(0,1)
    
    print('lr img:', lr_img.shape, lr_img.min(), lr_img.max())
    plt.figure()
    plt.imshow(lr_img.numpy().transpose(1,2,0))
