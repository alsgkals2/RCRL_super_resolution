...
class Encoder(nn.Module): #changeEncoder에 씅임
    def __init__(self):
    ...
    def forward(self, img):
        featmap_1_down = self.conv_featmap_1(img)
        # featmap_1_down = self.maxpool(featmap_1) #mhkim

        featmap_2_down = self.conv_featmap_2(featmap_1_down)
        # featmap_2_down = self.maxpool(featmap_2) #mhkim
